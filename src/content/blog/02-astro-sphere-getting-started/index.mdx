...
```js file=astro.config.js caption="Here is how you change the url" lines_start=8 link=https://github.com/HesitantlyHuman/astro-sphere/blob/5c8562ed9ec0590395df40bb4c43fc104cf33eaf/astro.config.mjs#L8-L11
...
```js link=https://www.youtube.com/watch?v=dQw4w9WgXcQ
// src/consts.ts
...
```js caption="Setting metadata entry for SEO purposes"
