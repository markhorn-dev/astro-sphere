...
export default function ArrowProjectCard({ entry, pill }: Props) {
  return (
      ...
      <div class="w-full group-hover:text-black group-hover:dark:text-white blend">
        <div class="flex flex-wrap items-center gap-2">
          ...
          <div class="text-sm uppercase">
            {formatGitHubDate(entry.updated_at)}
            {/* {entry.updated_at} */}
          </div>
        </div>
        ...
        {/*   {entry.tags.map((tag: string) => ( // this line has an error; Parameter 'tag' implicitly has an 'any' type.ts(7006) */}
